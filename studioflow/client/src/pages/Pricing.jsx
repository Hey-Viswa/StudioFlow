  ...
  const plans = [
    {
      ...
      price: '₹0',
      period: 'Forever free',
      description: 'Best for solo',
      features: ['Up to 2 active projects', 'Project management', 'Basic invoicing', 'Email support'],
      planId: 'starter',
      isFree: true,
    },
    {
      ...
      badge: 'POPULAR',
      features: ['Unlimited projects', 'Client collaboration', 'Branded invoices', 'Priority support'],
      planId: 'pro',
      isFree: false,
    },
    {
      ...
      period: '/mo',
      description: 'Teams',
      features: ['Everything in Pro', 'Team permissions', 'Advanced reviews', 'Dedicated support'],
      planId: 'studio',
      isFree: false,
    },
  ];
